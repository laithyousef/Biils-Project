                                                        ...
                                                        <div class="dropdown-menu tx-13">
                                                            <a class="dropdown-item" href="#" data-invoice_id="{{ $invoice->id }}"
                                                                data-toggle="modal" data-target="#Archive_invoice"><i
                                                                    class="text-warning fas fa-exchange-alt"></i>&nbsp;&nbsp;نقل الى الفواتير</a>
                                                            <a class="dropdown-item" href="#" data-invoice_id="{{ $invoice->id }}"
                 ...
                 <div class="modal-dialog" role="document">
                     <div class="modal-content">
                         <div class="modal-header">
                             ...
                             <form action="{{ route('Archive_invoices.destroy', 'invoice') }}" method="post">
                                 {{ method_field('delete') }}
                                 {{ csrf_field() }}
                         </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <form action="{{ route('Archive_invoices.update', 'Archive_invoice') }}" method="post">
                            {{ method_field('put') }}
                            {{ csrf_field() }}
                    </div>
