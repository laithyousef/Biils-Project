                    ...
                    <form action="{{ route('invoices.update', $invoices->id) }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select id="product" name="product" class="form-control">
                                    <option value="{{ $invoices->section->id }}">{{ $invoices->product }}</option>
                                </select>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select name="Rate_VAT" id="Rate_VAT" class="form-control" onchange="invoiceCalculate()">
                                    <!--placeholder-->
                                    <option value="{{ $invoices->id }}"> {{ $invoices->Rate_VAT }} </option>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="Value_VAT" name="Value_VAT" value="{{ $invoices->Value_VAT }}"
                                 readonly>
                            </div>
...
@section('js')
    ...
    <script>
        // grabing the value of section name
