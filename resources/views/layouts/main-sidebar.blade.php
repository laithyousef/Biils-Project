...
<aside class="app-sidebar sidebar-scroll">
	...
	<div class="main-sidemenu">
		...
		<ul class="side-menu">
			<li class="side-item side-item-category">برنامج إنشاء الفواتير</li>
			<li class="slide">
			...
			<li class="slide">
				...
				<ul class="slide-menu">
					...
					@can('أرشفة الفواتير')
					<li><a class="slide-item" href="{{ url('/' . $page='Archive_invoices') }}">الفواتير المؤرشفة</a></li>
					@endcan
			...
			<li class="slide">
				...
				<ul class="slide-menu">
					...
					@can('تقرير العملاء')
					<li><a class="slide-item" href="{{ url('/' . $page='custormers_report') }}">تقارير العملاء</a></li>
					@endcan
